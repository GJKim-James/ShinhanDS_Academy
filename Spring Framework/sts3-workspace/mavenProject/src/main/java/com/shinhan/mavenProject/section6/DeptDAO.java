...
//@Component // == Bean
@Repository // '@Component + DAO' 역할
// <bean id="deptDAO" class="com.shinhan.mavenProject.section6.DeptDAO"></bean>
public class DeptDAO {
	
	@Autowired // type이 같으면 자동으로 Injection
	DataSource ds; // (di6.xml의 <bean id="dataSource" class="org.springframework.jdbc.datasource.DriverManagerDataSource">)
